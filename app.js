    ...
    const demoNodes = [
        {
            id: 'node_demo_1',
            type: 'message',
            text: 'Привет! 🧠 Добро пожаловать в симулятор-тренинг «Мастер общения». Я твой персональный AI-коуч. Здесь мы разберем, как уверенно общаться с девушками и избегать досадных ошибок. Начнем с твоего имени?',
            x: 80,
            y: 300,
            next: 'node_demo_2'
        },
        {
            id: 'node_demo_2',
            type: 'input',
            text: 'Напишите ваше имя, чтобы мы начали тренинг:',
            x: 420,
            y: 300,
            variable: 'userName',
            next: 'node_demo_3'
        },
        {
            id: 'node_demo_3',
            type: 'choice',
            text: 'Отлично, {userName}! С чего начнем обучение? Напишите интересующий вас модуль: \n1. Как начать диалог (Первое сообщение) ✍️\n2. Ошибки во время флирта 🚫\n3. Как пригласить на свидание ☕',
            x: 760,
            y: 300,
            choices: [
                { id: 'c_module_start', text: 'Как начать диалог (Первое сообщение) ✍️', next: 'node_demo_first_message' },
                { id: 'c_module_mistakes', text: 'Ошибки во время флирта 🚫', next: 'node_demo_mistakes' },
                { id: 'c_module_date', text: 'Как пригласить на свидание ☕', next: 'node_demo_date' }
            ]
        },
        {
            id: 'node_demo_first_message',
            type: 'choice',
            text: 'Первое сообщение задает тон. Забудь про банальные «Привет, как дела?». Лучший подход — зацепиться за интересную деталь в профиле (хобби, фото). \n\nДавай проверим интуицию: у нее в профиле фото с гитарой в горах. Что ты ей напишешь?\n1. Крутая гитара! Давно играешь или это просто для фото? 🏔️\n2. Привет, давай познакомимся? Ты очень милая! 😊',
            x: 1120,
            y: 50,
            choices: [
                { id: 'c_msg_good', text: 'Крутая гитара! Давно играешь или это просто для фото? 🏔️', next: 'node_demo_msg_good' },
                { id: 'c_msg_bad', text: 'Привет, давай познакомимся? Ты очень милая! 😊', next: 'node_demo_msg_bad' }
            ]
        },
        {
            id: 'node_demo_msg_good',
            type: 'message',
            text: 'Отличный выбор! 🎯 Это открытый вопрос, показывающий внимание к ее интересам. Вопросы об увлечениях всегда получают ответы с большей вероятностью.',
            x: 1480,
            y: -10,
            next: 'node_demo_next_steps'
        },
        {
            id: 'node_demo_msg_bad',
            type: 'message',
            text: 'Увы, это слишком банально. ❌ Девушки получают десятки таких сообщений ежедневно и часто их игнорируют. Намного эффективнее зацепиться за контекст.',
            x: 1480,
            y: 110,
            next: 'node_demo_next_steps'
        },
        {
            id: 'node_demo_mistakes',
            type: 'choice',
            text: 'Главные ошибки в начале диалога — навязчивость, излишняя душнота и режим допроса. \n\nКакое поведение кажется тебе наиболее отталкивающим?\n1. Режим допроса (куча вопросов подряд) ❓\n2. Хвастовство (разговоры только о себе) 😎',
            x: 1120,
            y: 300,
            choices: [
                { id: 'c_mistake_interview', text: 'Допрос (слишком много вопросов подряд) ❓', next: 'node_demo_mistake_interview' },
                { id: 'c_mistake_brag', text: 'Хвастовство (рассказывать только о себе) 😎', next: 'node_demo_mistake_brag' }
            ]
        },
        {
            id: 'node_demo_mistake_interview',
            type: 'message',
            text: 'Абсолютно верно! 📋 Диалог не должен превращаться в резюме. Задав вопрос, поделись своим мнением на эту тему, соблюдай баланс 50/50.',
            x: 1480,
            y: 260,
            next: 'node_demo_next_steps'
        },
        {
            id: 'node_demo_mistake_brag',
            type: 'message',
            text: 'Тоже верно! 🚫 Хвастовство отталкивает. Вместо саморекламы лучше давать девушке возможность говорить о себе, мягко вплетая свои истории.',
            x: 1480,
            y: 380,
            next: 'node_demo_next_steps'
        },
        {
            id: 'node_demo_date',
            type: 'choice',
            text: 'Звать на свидание стоит, когда в переписке возникла легкая химия. Но место тоже важно. \n\nКуда лучше позвать девушку на первую встречу?\n1. В ресторан высокой кухни 🍽️\n2. На чашку кофе / прогулку в парк ☕',
            x: 1120,
            y: 550,
            choices: [
                { id: 'c_date_expensive', text: 'В ресторан высокой кухни 🍽️', next: 'node_demo_date_expensive' },
                { id: 'c_date_easy', text: 'На чашку кофе / прогулку в парк ☕', next: 'node_demo_date_easy' }
            ]
        },
        {
            id: 'node_demo_date_expensive',
            type: 'message',
            text: 'Ресторан высокой кухни — плохой выбор. ❌ Это создает лишнее напряжение, обязывает и лишает маневра. Первая встреча должна быть легкой.',
            x: 1480,
            y: 520,
            next: 'node_demo_next_steps'
        },
        {
            id: 'node_demo_date_easy',
            type: 'message',
            text: 'Идеально! ☕ Кофе или прогулка — ни к чему не обязывающий, комфортный формат. Снижает стресс для вас обоих и позволяет легко разойтись, если не совпали.',
            x: 1480,
            y: 640,
            next: 'node_demo_next_steps'
        },
        {
            id: 'node_demo_next_steps',
            type: 'choice',
            text: 'Полезен ли был этот урок, {userName}? Что делаем дальше?\n1. Пройти другой модуль 📚\n2. Завершить обучение 🎓',
            x: 1860,
            y: 300,
            choices: [
                { id: 'c_next_loop', text: 'Пройти другой модуль 📚', next: 'node_demo_3' },
                { id: 'c_next_finish', text: 'Завершить обучение 🎓', next: 'node_demo_finish' }
            ]
        },
        {
            id: 'node_demo_finish',
            type: 'input',
            text: 'Отлично! Напиши свой Telegram или Email, мы вышлем тебе полный чек-лист «Искусство диалога»:',
            x: 2200,
            y: 300,
        ...
        },
        {
            id: 'node_demo_final',
            type: 'end',
            text: 'Поздравляю, {userName}! Вводный тренинг пройден. Полный чек-лист отправлен на контакт: {userContact}. Применяй правила на практике и верь в свои силы! Удачи! 🚀',
            x: 2540,
            y: 300
        }
    ];
